...
* @returns {any}
*/
export function compile_nfa(nfa) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.compile_nfa(retptr, addHeapObject(nfa));
...
* @returns {any}
*/
export function match_string(input) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.match_string(retptr, addHeapObject(input));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function reset_automata() {
    const ret = wasm.reset_automata();
...
* @returns {any}
*/
export function next(letter) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.next(retptr, addHeapObject(letter));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function build_automata(val) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.build_automata(retptr, addHeapObject(val));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function automata_to_regex(automata) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.automata_to_regex(retptr, addHeapObject(automata));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_fromCodePoint_f58eba8f8e2336bb = function() { return handleError(function (arg0) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('automata_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
